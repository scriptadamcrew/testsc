...
clear
echo Installing Websocket-SSH BY NAKATA143
sleep 1
echo Cek Hak Akses...
sleep 0.5
cd
...
wget -O /usr/local/bin/ws-dropbear https://raw.githubusercontent.com/scriptadamcrew/testsc/main/websocket/ws-dropbear.py && chmod +x /usr/local/bin/ws-dropbear
wget -O /usr/local/bin/ws-ovpn https://raw.githubusercontent.com/scriptadamcrew/testsc/main/websocket/ws-ovpn.py && chmod +x /usr/local/bin/ws-ovpn
wget -O /usr/local/bin/ws-stunnel https://raw.githubusercontent.com/scriptadamcrew/testsc/main/websocket/ws-tls.py && chmod +x /usr/local/bin/ws-stunnel
